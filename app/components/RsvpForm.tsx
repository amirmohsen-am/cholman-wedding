...
export default function RsvpForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto">
      <div className="mb-5">
        <label htmlFor="name" className="block text-lg font-bold mb-2 text-white" style={{ fontFamily: "var(--font-sahitya)" }}>
        ...
        <input
          ...
          className="w-full px-4 py-3 border-2 border-white rounded-lg bg-white text-gray-900 text-lg font-medium focus:outline-none focus:ring-2 focus:ring-white/50 shadow-lg"
          style={{ fontFamily: "var(--font-sahitya)" }}
          required
        />
      </div>
      ...
      <div className="mb-5">
        <label htmlFor="email" className="block text-lg font-bold mb-2 text-white" style={{ fontFamily: "var(--font-sahitya)" }}>
        ...
        <input
          ...
          required
        />
        <p className="text-base text-white mt-2 font-medium" style={{ fontFamily: "var(--font-sahitya)" }}>We'll email you additional information</p>
      </div>

      <div className="mb-5">
        <label htmlFor="phone" className="block text-lg font-bold mb-2 text-white" style={{ fontFamily: "var(--font-sahitya)" }}>
          Phone (optional)
        </label>
        <input
          type="tel"
      ...
      <div className="mb-5">
        <label className="block text-lg font-bold mb-3 text-white" style={{ fontFamily: "var(--font-sahitya)" }}>
      ...
      <button
        ...
        className="w-full bg-white text-[#E85D3F] py-4 px-6 rounded-lg font-bold text-xl hover:bg-gray-50 disabled:bg-gray-300 disabled:text-gray-500 transition-colors shadow-lg"
        style={{ fontFamily: "var(--font-sahitya)" }}
      >
